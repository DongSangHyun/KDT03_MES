    ...
    public partial class WM_ProdInStock : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("SP00_WM_ProdInStock_S1", CommandType.StoredProcedure
        ...
        private void _doSave()
        {
            ...
            try
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    helper.ExecuteNoneQuery("SP00_WM_ProdInStock_U1", CommandType.StoredProcedure
