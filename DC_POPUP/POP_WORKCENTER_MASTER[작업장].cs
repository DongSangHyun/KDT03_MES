...
namespace DC_POPUP
{
    public partial class POP_WORKCENTER_MASTER : DC00_WinForm.BasePopupForm
    {
        ...
        private void POP_WORKCENTER_MASTER_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(Grid1, "PlantCode",       "사업장",      GridColDataType_emu.VarChar, 90,   Infragistics.Win.HAlign.Left,   true, false );
            _GridUtil.InitColumnUltraGrid(Grid1, "WORKCENTERCODE",  "작업장코드",  GridColDataType_emu.VarChar, 110,  Infragistics.Win.HAlign.Center, true, false );
            _GridUtil.InitColumnUltraGrid(Grid1, "WORKCENTERNAME",  "작업장명",    GridColDataType_emu.VarChar, 250,  Infragistics.Win.HAlign.Left,   true, false );
            _GridUtil.InitColumnUltraGrid(Grid1, "UseFlag",         "사용유무",    GridColDataType_emu.VarChar, 100,  Infragistics.Win.HAlign.Left,   true, false );
