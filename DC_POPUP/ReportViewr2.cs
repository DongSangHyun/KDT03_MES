...
namespace DC_POPUP
{
    public partial class ReportViewr2 : DC00_WinForm.BasePopupForm
    {
        ...
        Report_specification_on_transaction[] MM0300X_Report = new Report_specification_on_transaction[10];

        Report_specification_on_transaction MM0300X_Report_N;
        ...
        public ReportViewr2(DataTable dtTemp, string PrePrintFlag)
        {
            ...
            foreach (DataRow dr_Grid in dtTemp.Rows)
            {
                ...
                //데이터 바인딩
                MM0300X_Report[a] = new Report_specification_on_transaction();
        ...
        private Boolean Inquire()
        {
            ...
            try
            {
                ...
                {
                    //원본
                    MM0300X_Report_N = new Report_specification_on_transaction();
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            Telerik.Reporting.IReportDocument myReport = new Report_specification_on_transaction();
