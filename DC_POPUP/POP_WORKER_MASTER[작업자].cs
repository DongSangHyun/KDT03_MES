...
namespace DC_POPUP
{
    public partial class POP_WORKER_MASTER : DC00_WinForm.BasePopupForm
    {
        ...
        private void POP_WORKER_MASTER_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(Grid1,"PlantCode",     "사업장",     GridColDataType_emu.VarChar, 100, Infragistics.Win.HAlign.Center, true,  false );
            _GridUtil.InitColumnUltraGrid(Grid1,"PlantCodeNm",   "공장명",     GridColDataType_emu.VarChar, 100, Infragistics.Win.HAlign.Left,   false, false );
            _GridUtil.InitColumnUltraGrid(Grid1,"OPCode",        "공정코드",   GridColDataType_emu.VarChar, 100, Infragistics.Win.HAlign.Center, false, false );
            _GridUtil.InitColumnUltraGrid(Grid1,"LineCode",      "라인",       GridColDataType_emu.VarChar, 100, Infragistics.Win.HAlign.Center, false, false );
            _GridUtil.InitColumnUltraGrid(Grid1,"WorkCenterCode","작업장코드", GridColDataType_emu.VarChar, 120, Infragistics.Win.HAlign.Center, false, false );
            _GridUtil.InitColumnUltraGrid(Grid1,"WorkerID",      "작업자ID",   GridColDataType_emu.VarChar, 100, Infragistics.Win.HAlign.Left,   true,  false );
            _GridUtil.InitColumnUltraGrid(Grid1,"WorkerName",    "작업자명",   GridColDataType_emu.VarChar, 200, Infragistics.Win.HAlign.Left,   true,  false );
